    ...
    try:
        while True:
            ...
            message = messaging.Message(
                notification=messaging.Notification(title=f'{call_data.caller_phone_number} is calling'), data={'message': call_data.message, 'caller_phone_number': call_data.caller_phone_number, 'red': call_data.background_color.red, 'blue': call_data.background_color.blue, 'green': call_data.background_color.green, 'alpha': call_data.background_color.alpha}, token=document['fcmToken'],)
